---
title: 瞭解評估集
description: 瞭解評估集如何幫助您測試Brand Concierge是否正確回答、是否在範圍內，以及在上線前安全地處理棘手的問題。
...
評估可告訴您您的Adobe Brand Concierge是否正確回答、保持在範圍內，以及安全處理複雜的問題。 本影片會逐步解說三種評估型別（功能、超出範圍和保護），並示範如何建立評估集、執行評估集，以及在您上線前檢閱標幟的結果。
